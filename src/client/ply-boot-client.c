                             ...
                             bool                                ignore_replies)
{
  ...
  request->ignore_replies = ignore_replies;
                               ...
                               bool                                ignore_replies)
{
  ...
  ply_boot_client_queue_request (client, PLY_BOOT_PROTOCOL_REQUEST_TYPE_UPDATE,
                                 status, handler, failed_handler, user_data, ignore_replies);
}
                                            ...
                                            bool                                ignore_replies)
{
  ...
  ply_boot_client_queue_request(client, PLY_BOOT_PROTOCOL_REQUEST_TYPE_NEWROOT,
                                root_dir, handler, failed_handler, user_data, ignore_replies);
}
                                                ...
                                                bool                                ignore_replies)
{
  ...
  ply_boot_client_queue_request (client, PLY_BOOT_PROTOCOL_REQUEST_TYPE_SHOW_MESSAGE,
                                 message, handler, failed_handler, user_data, ignore_replies);
}
                                                   ...
                                                   bool                                ignore_replies)
{
  ...
  ply_boot_client_queue_request (client,
                                 ...
                                 NULL, handler, failed_handler, user_data, ignore_replies);
}
                                         ...
                                         bool                                       ignore_replies)
{
  ...
  ply_boot_client_queue_request (client, PLY_BOOT_PROTOCOL_REQUEST_TYPE_KEYSTROKE_REMOVE,
                                 keys, (ply_boot_client_response_handler_t)
                                 handler, failed_handler, user_data, ignore_replies);
}
                                     ...
                                     bool                                ignore_replies)
{
  ...
  ply_boot_client_queue_request (client, PLY_BOOT_PROTOCOL_REQUEST_TYPE_QUIT,
                                 arg, handler, failed_handler, user_data, ignore_replies);
}
